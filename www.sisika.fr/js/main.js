	...
	function startImageHeader(){
		...
		new preLoader([dataHeader[activeIndex].bigImage, dataHeader[prevIndex].bigImage, dataHeader[nextIndex].bigImage], {
			onComplete: function(loaded, errors){
				...
				var brokenImage = "images/broken-image.html",
	    ...
	    new preLoader(portImage, {
	    	onComplete : function(load, errors){
	    		$.each(portfolio, function(a, b){
			        ...
			        var portList = $('<figure class="portfolio-view ' + b.category + '" style="width:' + portWidth + 'px;height:' + (portWidth-113) + 'px"><img src="' + image + '" style="max-width: 100%; height: auto;" alt="Project Image"><figcaption><h2>' + b.title + '</span></h2><p>' + b.text + '</p><a href="' + b.link + '" target="_blank">View more</a></figcaption></figure>');
...
document.getElementById('projects').setAttribute('data-to', portfolio.length);